# # -*- coding: utf-8 -*-
# """
# Created on Sun Mar 27 05:43:46 2022
...
#         fb.columns = ["Nombre","Descripcion","URL Post","Likes","Loves","HAHAs","WOWs","Sads","Hates","Cares"]
#         fb.to_excel("Movimiento Regional AGUA - Ancash.xlsx",index=False)
    
     

# correo="prueballoreda@gmail.com"
# contra="N3gr4f34"
# direct=r"C:\Users\llore\Jupyter\Scrapers\Sunat"
# driver_path=r"C:\Python3.10\Lib\site-packages\selenium\chromedriver.exe"

# s = FB_scraper(correo=correo, contra=contra,direct=direct,driver_path=driver_path)
# x = 0
# for scrapeados in ["https://www.facebook.com/AguaRegionAncash"]:
#     s.scrape(url=scrapeados,num_de_pub=9)
#     exec(f"bd_{x}=pd.read_excel('Movimiento Regional AGUA - Ancash.xlsx')")
#     x = x + 1
